...
import MediaPopupSequence from "./MediaPopUpSequence";
      ...
      <div className="welcome-popup">
        ...
        <div className="welcome-content">
          <div className="welcome-text">
            ...
            <p>
              Ktown cannot be encapsulated into a single definition. Ktown acts
              as an experimental aesthetic exploration, a multiple body of
              assemblages, a cognitive system, a space of abstractions and
              reasons, a duration, a critical artifact. This world's intent is
              to generate new worlds through recursive dynamics and structures,
              as well as using language models to produce new narratives and
              stories.
            </p>

            <p>
              The map is visually text-based, with its elements and characters
              represented by numbers, letters and symbols, all inserted into a
              tile-based graphic. These symbols are representations of the data
              which, in its raw state, has been mediated through artificial
              intelligence and then parsed and integrated into the map
              interface. It uses a signifying layer based on characters and
              layers. Using a fractal map with an interactive zoom. The map is a
              representation of the world's data, and the data is a
              representation of the world's structure and content.
            </p>
